...
import app.foody_app.global.Constants.Companion.BASE_IMAGE_URL
import app.foody_app.models.ExtendedIngredient
...
class IngredientsAdapter : RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.ingredient_amount.text =
            ingredientsList[position].amount.toString()
        holder.itemView.ingredient_unit.text =
            ingredientsList[position].unit
        holder.itemView.ingredient_consistency.text =
            ingredientsList[position].consistency
        holder.itemView.ingredient_original.text =
